...
class _DiscoverState extends State<Discover> {
  ...
  void initState() {
    ...
    bluetoothState.serviceInit(BluetoothMode.browsing);
    super.initState();
  }
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Obx(() {
                return Expanded(
                    child: (bluetoothState.isEmpty.value)
                        ? Container(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(
                                              "${bluetoothState.recvdUsers[userCounter]["name"]}, ${bluetoothState.recvdUsers[userCounter]["gender"][0]}${DateTime.now().year - int.parse(bluetoothState.recvdUsers[userCounter]["age"].split("-")[0])}",
